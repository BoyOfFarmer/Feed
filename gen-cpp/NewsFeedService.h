...
class NewsFeedServiceIf {
 public:
  ...
  virtual void createProfile(ProfileCreateResult& _return, const std::string& name, const int8_t gender, const int32_t birthday) = 0;
  virtual void getProfile(ProfileResult& _return, const int32_t id) = 0;
...
typedef struct _NewsFeedService_createProfile_args__isset {
  _NewsFeedService_createProfile_args__isset() : name(false), gender(false), birthday(false) {}
  bool name :1;
  bool gender :1;
  bool birthday :1;
} _NewsFeedService_createProfile_args__isset;

class NewsFeedService_createProfile_args {
 public:

  NewsFeedService_createProfile_args(const NewsFeedService_createProfile_args&);
  NewsFeedService_createProfile_args& operator=(const NewsFeedService_createProfile_args&);
  NewsFeedService_createProfile_args() : name(), gender(0), birthday(0) {
  }

  virtual ~NewsFeedService_createProfile_args() throw();
  std::string name;
  int8_t gender;
  int32_t birthday;

  _NewsFeedService_createProfile_args__isset __isset;
  ...
  bool operator == (const NewsFeedService_createProfile_args & rhs) const
  {
    if (!(name == rhs.name))
      return false;
  ...
  bool operator < (const NewsFeedService_createProfile_args & ) const;
...
class NewsFeedService_createProfile_pargs {
 public:


  virtual ~NewsFeedService_createProfile_pargs() throw();
  const std::string* name;
  const int8_t* gender;
  const int32_t* birthday;

  uint32_t write(::apache::thrift::protocol::TProtocol* oprot) const;

};

typedef struct _NewsFeedService_createProfile_result__isset {
  _NewsFeedService_createProfile_result__isset() : success(false) {}
  bool success :1;
} _NewsFeedService_createProfile_result__isset;

class NewsFeedService_createProfile_result {
 public:

  NewsFeedService_createProfile_result(const NewsFeedService_createProfile_result&);
  NewsFeedService_createProfile_result& operator=(const NewsFeedService_createProfile_result&);
  NewsFeedService_createProfile_result() {
  }

  virtual ~NewsFeedService_createProfile_result() throw();
  ProfileCreateResult success;

  _NewsFeedService_createProfile_result__isset __isset;

  void __set_success(const ProfileCreateResult& val);

  bool operator == (const NewsFeedService_createProfile_result & rhs) const
  {
  ...
  bool operator < (const NewsFeedService_createProfile_result & ) const;
...
typedef struct _NewsFeedService_createProfile_presult__isset {
  _NewsFeedService_createProfile_presult__isset() : success(false) {}
  bool success :1;
} _NewsFeedService_createProfile_presult__isset;

class NewsFeedService_createProfile_presult {
 public:


  virtual ~NewsFeedService_createProfile_presult() throw();
  ProfileCreateResult* success;

  _NewsFeedService_createProfile_presult__isset __isset;

  uint32_t read(::apache::thrift::protocol::TProtocol* iprot);

};

typedef struct _NewsFeedService_getProfile_args__isset {
  _NewsFeedService_getProfile_args__isset() : id(false) {}
  bool id :1;
} _NewsFeedService_getProfile_args__isset;

class NewsFeedService_getProfile_args {
 public:

  NewsFeedService_getProfile_args(const NewsFeedService_getProfile_args&);
  NewsFeedService_getProfile_args& operator=(const NewsFeedService_getProfile_args&);
  NewsFeedService_getProfile_args() : id(0) {
  }

  virtual ~NewsFeedService_getProfile_args() throw();
  int32_t id;

  _NewsFeedService_getProfile_args__isset __isset;

  void __set_id(const int32_t val);

  bool operator == (const NewsFeedService_getProfile_args & rhs) const
  {
    if (!(id == rhs.id))
      return false;
    return true;
  ...
  bool operator < (const NewsFeedService_getProfile_args & ) const;
...
class NewsFeedService_getProfile_pargs {
 public:


  virtual ~NewsFeedService_getProfile_pargs() throw();
  const int32_t* id;
...
typedef struct _NewsFeedService_getProfile_result__isset {
  _NewsFeedService_getProfile_result__isset() : success(false) {}
  bool success :1;
} _NewsFeedService_getProfile_result__isset;

class NewsFeedService_getProfile_result {
 public:

  NewsFeedService_getProfile_result(const NewsFeedService_getProfile_result&);
  NewsFeedService_getProfile_result& operator=(const NewsFeedService_getProfile_result&);
  NewsFeedService_getProfile_result() {
  }

  virtual ~NewsFeedService_getProfile_result() throw();
  ProfileResult success;

  _NewsFeedService_getProfile_result__isset __isset;

  void __set_success(const ProfileResult& val);

  bool operator == (const NewsFeedService_getProfile_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    return true;
  ...
  bool operator < (const NewsFeedService_getProfile_result & ) const;
...
typedef struct _NewsFeedService_getProfile_presult__isset {
  _NewsFeedService_getProfile_presult__isset() : success(false) {}
  bool success :1;
} _NewsFeedService_getProfile_presult__isset;

class NewsFeedService_getProfile_presult {
 public:


  virtual ~NewsFeedService_getProfile_presult() throw();
  ProfileResult* success;

  _NewsFeedService_getProfile_presult__isset __isset;
...
class NewsFeedServiceClient : virtual public NewsFeedServiceIf {
 ...
 public:
  ...
  void createProfile(ProfileCreateResult& _return, const std::string& name, const int8_t gender, const int32_t birthday);
  void send_createProfile(const std::string& name, const int8_t gender, const int32_t birthday);
  void recv_createProfile(ProfileCreateResult& _return);
  void getProfile(ProfileResult& _return, const int32_t id);
  void send_getProfile(const int32_t id);
  void recv_getProfile(ProfileResult& _return);
  void createNewsFeed(FeedCreateResult& _return, const int32_t owner, const std::string& content, const int8_t status);
...
class NewsFeedServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  NewsFeedServiceProcessor(boost::shared_ptr<NewsFeedServiceIf> iface) :
    iface_(iface) {
    processMap_["createProfile"] = &NewsFeedServiceProcessor::process_createProfile;
    processMap_["getProfile"] = &NewsFeedServiceProcessor::process_getProfile;
...
class NewsFeedServiceMultiface : virtual public NewsFeedServiceIf {
 ...
 public:
  void createProfile(ProfileCreateResult& _return, const std::string& name, const int8_t gender, const int32_t birthday) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->createProfile(_return, name, gender, birthday);
    }
    ifaces_[i]->createProfile(_return, name, gender, birthday);
    return;
  }
  ...
  void getProfile(ProfileResult& _return, const int32_t id) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->getProfile(_return, id);
    }
    ifaces_[i]->getProfile(_return, id);
    return;
  }
...
class NewsFeedServiceConcurrentClient : virtual public NewsFeedServiceIf {
 ...
 public:
  ...
  void createProfile(ProfileCreateResult& _return, const std::string& name, const int8_t gender, const int32_t birthday);
  int32_t send_createProfile(const std::string& name, const int8_t gender, const int32_t birthday);
  void recv_createProfile(ProfileCreateResult& _return, const int32_t seqid);
  void getProfile(ProfileResult& _return, const int32_t id);
  int32_t send_getProfile(const int32_t id);
  void recv_getProfile(ProfileResult& _return, const int32_t seqid);
  void createNewsFeed(FeedCreateResult& _return, const int32_t owner, const std::string& content, const int8_t status);
