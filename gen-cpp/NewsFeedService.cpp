...
NewsFeedService_createProfile_args::~NewsFeedService_createProfile_args() throw() {
}


uint32_t NewsFeedService_createProfile_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t NewsFeedService_createProfile_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("NewsFeedService_createProfile_args");

  xfer += oprot->writeFieldBegin("name", ::apache::thrift::protocol::T_STRING, 1);
  xfer += oprot->writeString(this->name);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("gender", ::apache::thrift::protocol::T_BYTE, 2);
  xfer += oprot->writeByte(this->gender);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("birthday", ::apache::thrift::protocol::T_I32, 3);
...
NewsFeedService_createProfile_pargs::~NewsFeedService_createProfile_pargs() throw() {
}


uint32_t NewsFeedService_createProfile_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("NewsFeedService_createProfile_pargs");
...
NewsFeedService_createProfile_result::~NewsFeedService_createProfile_result() throw() {
}


uint32_t NewsFeedService_createProfile_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t NewsFeedService_createProfile_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("NewsFeedService_createProfile_result");
...
NewsFeedService_createProfile_presult::~NewsFeedService_createProfile_presult() throw() {
}


uint32_t NewsFeedService_createProfile_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
NewsFeedService_getProfile_args::~NewsFeedService_getProfile_args() throw() {
}


uint32_t NewsFeedService_getProfile_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t NewsFeedService_getProfile_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("NewsFeedService_getProfile_args");
...
NewsFeedService_getProfile_pargs::~NewsFeedService_getProfile_pargs() throw() {
}


uint32_t NewsFeedService_getProfile_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("NewsFeedService_getProfile_pargs");
...
NewsFeedService_getProfile_result::~NewsFeedService_getProfile_result() throw() {
}


uint32_t NewsFeedService_getProfile_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t NewsFeedService_getProfile_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("NewsFeedService_getProfile_result");
...
NewsFeedService_getProfile_presult::~NewsFeedService_getProfile_presult() throw() {
}


uint32_t NewsFeedService_getProfile_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void NewsFeedServiceClient::createProfile(ProfileCreateResult& _return, const std::string& name, const int8_t gender, const int32_t birthday)
{
  send_createProfile(name, gender, birthday);
  recv_createProfile(_return);
}

void NewsFeedServiceClient::send_createProfile(const std::string& name, const int8_t gender, const int32_t birthday)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("createProfile", ::apache::thrift::protocol::T_CALL, cseqid);

  NewsFeedService_createProfile_pargs args;
  args.name = &name;
  args.gender = &gender;
...
void NewsFeedServiceClient::recv_createProfile(ProfileCreateResult& _return)
{
  ...
  NewsFeedService_createProfile_presult result;
...
void NewsFeedServiceClient::getProfile(ProfileResult& _return, const int32_t id)
{
  send_getProfile(id);
  recv_getProfile(_return);
}

void NewsFeedServiceClient::send_getProfile(const int32_t id)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("getProfile", ::apache::thrift::protocol::T_CALL, cseqid);

  NewsFeedService_getProfile_pargs args;
  args.id = &id;
  args.write(oprot_);
...
void NewsFeedServiceClient::recv_getProfile(ProfileResult& _return)
{
  ...
  NewsFeedService_getProfile_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
...
void NewsFeedServiceProcessor::process_createProfile(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("NewsFeedService.createProfile", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "NewsFeedService.createProfile");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "NewsFeedService.createProfile");
  }

  NewsFeedService_createProfile_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "NewsFeedService.createProfile", bytes);
  }

  NewsFeedService_createProfile_result result;
  try {
    iface_->createProfile(result.success, args.name, args.gender, args.birthday);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "NewsFeedService.createProfile");
    }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "NewsFeedService.createProfile");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "NewsFeedService.createProfile", bytes);
  }
}

void NewsFeedServiceProcessor::process_getProfile(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("NewsFeedService.getProfile", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "NewsFeedService.getProfile");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "NewsFeedService.getProfile");
  }

  NewsFeedService_getProfile_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "NewsFeedService.getProfile", bytes);
  }

  NewsFeedService_getProfile_result result;
  try {
    iface_->getProfile(result.success, args.id);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "NewsFeedService.getProfile");
    }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "NewsFeedService.getProfile");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "NewsFeedService.getProfile", bytes);
  }
}
...
void NewsFeedServiceConcurrentClient::createProfile(ProfileCreateResult& _return, const std::string& name, const int8_t gender, const int32_t birthday)
{
  int32_t seqid = send_createProfile(name, gender, birthday);
  recv_createProfile(_return, seqid);
}

int32_t NewsFeedServiceConcurrentClient::send_createProfile(const std::string& name, const int8_t gender, const int32_t birthday)
{
...
void NewsFeedServiceConcurrentClient::recv_createProfile(ProfileCreateResult& _return, const int32_t seqid)
{
...
void NewsFeedServiceConcurrentClient::getProfile(ProfileResult& _return, const int32_t id)
{
  int32_t seqid = send_getProfile(id);
  recv_getProfile(_return, seqid);
}

int32_t NewsFeedServiceConcurrentClient::send_getProfile(const int32_t id)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("getProfile", ::apache::thrift::protocol::T_CALL, cseqid);
...
void NewsFeedServiceConcurrentClient::recv_getProfile(ProfileResult& _return, const int32_t seqid)
{
